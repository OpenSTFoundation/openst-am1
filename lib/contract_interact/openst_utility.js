...
const OpenStUtilityKlass = function(contractAddress) {
  ...
  OpsManagedKlass.call(this, contractAddress, web3Provider, openSTUtilityContractObj, oThis.UC_GAS_PRICE);
};

// adding the methods from OpsMangedContract
//OpenStUtilityKlass.prototype = Object.create(OwnedKlass.prototype);
OpenStUtilityKlass.prototype = Object.create(OpsManagedKlass.prototype);

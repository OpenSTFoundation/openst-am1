...
program
  ...
  .option(
    '-s, --step <step>',
    'Step to be performed. (all|utility|fresh_setup|generate_addresses|init_value_chain|init_utility_chain|dynamo_db_create_shards|st_contract|fund_users_with_st|deploy_value_chain|deploy_utility_chain|snm_intercomm|snmp_intercomm|st_prime_mint|stop_utility_services|stop_value_services)',
    /^(all|utility|fresh_setup|generate_addresses|init_value_chain|init_utility_chain|dynamo_db_create_shards|st_contract|fund_users_with_st|deploy_value_chain|deploy_utility_chain|snm_intercomm|snmp_intercomm|st_prime_mint|stop_utility_services|stop_value_services)$/i,
    'all'
  )
